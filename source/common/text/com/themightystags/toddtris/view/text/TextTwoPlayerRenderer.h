...
#ifndef TextTwoPlayerRenderer_H
#define TextTwoPlayerRenderer_H
...
namespace com {
	namespace themightystags {
		namespace toddtris {
			namespace view {
				namespace text {
					class TextTwoPlayerRenderer:
							public TwoPlayerRenderer {
					public:
						TextTwoPlayerRenderer();
						virtual ~TextTwoPlayerRenderer();
						...
						static TextTwoPlayerRenderer &getInstance();

					protected:
						WellRenderer &getWellRenderer(int index);

					private:
						TextWellRenderer wellRenderer0;
						TextWellRenderer wellRenderer1;
						static TextTwoPlayerRenderer *INSTANCE;
						static bool initialised;
						const vector<string> *renderedOptions;
						int renderedScores[2];
						int renderedIndex;
					};
				}
			}
